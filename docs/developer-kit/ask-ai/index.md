...
[← MCP & Ask AI overview](../mcp/index.md)
...
> **Want a detailed step-by-step walkthrough for VS Code?** Check out the companion guide: [Ask AI in VS Code](vs-code-guide.md) – complete with annotated screenshots.
